              ...
              <div className="bg-gradient-to-br from-blue-600/20 to-purple-600/20 p-8 lg:p-10 flex flex-col justify-center items-center text-center lg:min-h-[500px]">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-gray-300 text-lg">
                    Your atlas to the world's stock markets
                  </p>
                </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div className="flex justify-center mb-4">
                        <div className="relative">
                          {photoPreview ? (
                            ...
                            <div className="w-16 h-16 rounded-full border-2 border-dashed border-white/30 flex flex-col items-center justify-center bg-white/5 hover:bg-white/10 transition-colors cursor-pointer">
                              <input
                                type="file"
                                accept="image/*"
                                ...
                                id="photo-upload"
                              />
                              <Upload size={16} className="text-white/60 mb-1" />
                              <span className="text-xs text-white/60">Photo</span>
                            </div>
                          )}
                        </div>
                        {errors.photo && <p className="text-red-400 text-xs mt-1 text-center">{errors.photo}</p>}
                      </div>
                    )}
                    ...
                    {state === 'Sign Up' && (
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-2.5 bg-white/10 border ${errors.userName ? 'border-red-500' : 'border-white/20'} rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm transition-colors`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 bg-white/10 border ${errors.email ? 'border-red-500' : 'border-white/20'} rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm transition-colors`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-4 py-2.5 pr-10 bg-white/10 border ${errors.password ? 'border-red-500' : 'border-white/20'} rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm transition-colors`}
